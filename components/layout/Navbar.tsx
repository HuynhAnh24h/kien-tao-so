  ...
  return (
    <>
      <nav
        ...
        style={{
          background: scrolled ? "rgba(30,42,58,0.98)" : "rgba(30,42,58,0.85)",
        }}
      >
        {/* Logo */}
        <Link href="/" className="flex items-center gap-3">
          ...
          <span
            className="font-sora font-bold text-[1.1rem] gradient-text"
              ...
              <li key={l.href}>
                <Link
                  ...
                  className={`text-sm font-medium tracking-wide transition-colors ${
                    isActive
                      ? "text-[#FE9677]"
                      : "text-white/85 hover:text-[#FE9677]"
                  }`}
                >
                  {l.label}
                </Link>
          ...
          <li>
            <a
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(246,70,104,0.3)",
              }}
            >
              <Phone size={14} />
              Liên hệ ngay
      ...
      {mobileOpen && (
        <div
          className="fixed inset-0 z-[99] flex flex-col items-center justify-center gap-8 backdrop-blur-2xl"
        ...
        >
          ...
          {navLinks.map((l) => {
            ...
            return (
              ...
              after:bg-[#FE9677] after:transition-all after:duration-300
              ${isActive ? "after:w-full text-[#FE9677]" : "after:w-0 hover:after:w-full"}
              `}
              >
                {l.label}
              </Link>
